...
;礼物盒狗粮智能筛选领取。请在礼物盒筛选功能中，去掉狗粮以外所有内容
;处于领取界面时，启动脚本即可。

;请在MUMU模拟器里的键盘设置里，加入鼠标向上划动3个狗粮栏位宽度的操作，并将触发键设为“=”键。
...
selexp:
	...
	loop
	{
		y:=y+10
		bingo:=0
		PixelSearch, x,y,436,y,436,920,0xFDFDFD,5,Fast RGB
		if(y)
		{
